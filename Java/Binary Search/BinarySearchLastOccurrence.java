...
public class BinarySearchLastOccurrence {
    ...
    public static void main(String args[]) {
        ...
        int key = sc.nextInt();
        System.out.println(
                "Binary Search Last Occurrence Iterative: " + binarySearchLastOccurrenceIterative(input, n, key));
        System.out.println("Binary Search Last Occurrence Recursive: "
                + binarySearchLastOccurrenceRecursive(input, 0, n - 1, key, -1));
        sc.close();
    }
}
