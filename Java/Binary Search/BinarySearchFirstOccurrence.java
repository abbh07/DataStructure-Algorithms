...
public class BinarySearchFirstOccurrence {
    ...
    public static void main(String args[]) {
        ...
        int key = sc.nextInt();
        System.out.println(
                "Binary Search First Occurrence Iterative: " + binarySearchFirstOccurrenceIterative(input, n, key));
        System.out.println("Binary Search First Occurrence Recursive: "
                + binarySearchFirstOccurrenceRecursive(input, 0, n - 1, key, -1));
        sc.close();
    }
}
